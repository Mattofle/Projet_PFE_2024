...
@Component({
  selector: 'app-recursive-module-esg',
  templateUrl: './recursive-module-esg.component.html',
  styleUrls: ['./recursive-module-esg.component.css'],
  imports: [CommonModule, QuestionEsgComponent],
})
export class RecursiveModuleEsgComponent implements OnInit {
